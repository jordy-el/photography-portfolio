...
ActiveRecord::Schema.define(version: 20170806064755) do
  ...
  create_table "parallaxes", force: :cascade do |t|
    t.bigint "krissi_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    ...
    t.index ["krissi_id"], name: "index_parallaxes_on_krissi_id"
  end
  ...
  add_foreign_key "parallaxes", "krissis"
